...
class CookbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post cookbooks_url, params: { cookbook: { author: @cookbook.author, cuisine: @cookbook.cuisine, title: @cookbook.title, year: @cookbook.year } }
    end
  ...
  test "should update cookbook" do
    patch cookbook_url(@cookbook), params: { cookbook: { author: @cookbook.author, cuisine: @cookbook.cuisine, title: @cookbook.title, year: @cookbook.year } }
